...
public class AcceptClient implements Runnable{
	...
	private static echec.Echequier plateau = null;
	private static GameOfChess game = null;
	...
	public void run() {
		...
		while(true){
			...
			try {
				...
				try {
					handleMessage.join();
					System.out.println(this.getClientThread());
	...
	public static echec.Echequier getPlateau() {
		return plateau;
	}

	public static void setPlateau(echec.Echequier plateau) {
		AcceptClient.plateau = plateau;
	}

	public static GameOfChess getGame() {
		return game;
	}

	public static void setGame(GameOfChess game) {
		AcceptClient.game = game;
	}
